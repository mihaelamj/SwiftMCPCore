...
// Included so this core is a true superset of cupertino's MCP.Core.Protocols and
// can lift verbatim into a neutral swift-mcp-core. The client targets do not use
// the prompt verbs yet; these are the wire types, mirrored field-for-field.
