...
public extension MCP.Core.Protocols {
    struct EmbeddedResource: Codable, Sendable {
...
public extension MCP.Core.Protocols {
    enum ResourceContents: Codable, Sendable {
        ...
        public func encode(to encoder: Encoder) throws {
            switch self {
            case let .text(contents):
                try contents.encode(to: encoder)
            case let .blob(contents):
                try contents.encode(to: encoder)
            }
        }
    }
...
public extension MCP.Core.Protocols {
    struct TextResourceContents: Codable, Sendable {
...
public extension MCP.Core.Protocols {
    struct BlobResourceContents: Codable, Sendable {
        public let uri: String
        public let mimeType: String?
